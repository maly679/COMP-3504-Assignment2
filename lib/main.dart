...
class ListSearchState extends State<ListSearch> {
  ...
  Future<void> _loadData() async {
    ...
    //once data is loaded, set loading to false, so inventory data can be shown on widget.
                ...
                onPressed: () async {
                  ...
                  setState(() {
                    ...
                    for (var i = 0; i < updatedData.length; i++) {
                      mainDataList.add('${updatedData[i].name.toString()};${updatedData[i].id.toString()}');
